...
const data = [
  {
    ...
    imageUrl: require('./assets/imagens/comerc.png'),
    logoUrl: require('./assets/imagens/castilho.jpg'),
    screen: 'DetalhesOlímpia',
  },
  {
    id: 2,
    title: 'São Paulo - SP',
    ...
    imageUrl: require('./assets/imagens/comerc.png'),
    logoUrl: require('./assets/imagens/saopaulo.jpg'),
...
export function TourismDetailsScreen() {
  ...
  React.useLayoutEffect(() => {
    navigation.setOptions({
      title: 'Cidades', // Definindo o título da tela como 'Cidades'
    });
  }, [navigation]);
